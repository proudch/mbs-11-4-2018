            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img class="d-block img-fluid" src="img/OTOP.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="img/coffe.jpg" alt="Second slide">
                    </div>
<!--                     <div class="carousel-item">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card h-100 text-center">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">OTOP ทั่วไทยรวมใจสู่ชายแดนใต้</h4>
                                
                                <p class="card-text">เตรียมพบกับงานแฟร์ที่ทุกคนชื่นชอบกันอีกเช่นเคย กับงาน OTOP ทั่วไทยรวมใจสู่ชายแดนใต้ ประจำปี 2561  ยังคงอัดแน่นด้วยสินค้าชุมชนคุณภาพดี จากทั่วไทย ในระหว่างวันที่ 23 มีนาคม ถึง 1 เมษายน2561...ที่ ศูนย์ประชุมนานาชาติฉลองสิริราชสมบัติครบ ๖๐ ปี อ.หาดใหญ่ จ.สงขลา</p>

                            </div>
                            <div class="card-footer">
                                <a href="http://localhost/mbs/public/event1" class="btn btn-primary">รายละเอียด</a>
                                <a href='http://localhost/mbs/public/rent' class='btn btn-info'> จองบูธ</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-4">
                        <div class="card h-100 text-center">
                            <img class="card-img-top" src="img/coffe.jpg" alt="">
                            <div class="card-body">
                                <h4 class="card-title">Summer Bitter Sweet 2018</h4>
                                
                                <p class="card-text">Summer Bitter Sweet 2018 เทศกาลขนมหวาน เบเกอรี่ ไอศกรีม กาแฟ และเครื่องดื่ม รับหน้าร้อน  พบกับร้านขนม เครื่องดื่ม ชื่อดัง เรตติ้งดี กว่า 70 ร้าน พลาดไม่ได้...กับการมาถ่ายรูป เช็คอิน นั่งชิล จิบม็อคเทลเก๋ๆ  ฟังดนตรีเพลินๆ ที่ Summer Breeze Bar และพาลูกๆ มาเวิร์คช๊อปศิลปะและทำขนมใ </p>
                            </div>
                            <div class="card-footer">
                                <a href="http://localhost/mbs/public/event1" class="btn btn-primary">รายละเอียด</a>
                                <a href='http://localhost/mbs/public/rent' class='btn btn-info'> จองบูธ</a>
                        ...
                        <div class="card h-100 text-center">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus aut mollitia eum ipsum
                                    fugiat odio officiis odit.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus aut mollitia eum ipsum
                                    fugiat odio officiis odit.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus aut mollitia eum ipsum
