...
<head>
    ...
    <title>ADMIN | แก้ไข้ข้อมูลงานนิทรรศการ</title>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="/admin-update-event"> แก้ไข้ข้อมูลงานนิทรรศการ</a>
                    </div>
            ...
            <div class="content">
                <div class="container-fluid">
                    <!-- <form class="form" method="" action=""> -->
                        <form action="http://localhost/mbs/public/admin-update-event" method="post" >  

                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header" data-background-color="red">
                                        <h4 class="title">เแก้ไขข้อมูลงานนิทรรศการ</h4>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <?php
                                                                echo "<input type='hidden' id='id' name='id' value='".$ev->id."'>";
                                                                echo "<label>ชื่องาน</label>";
                                                               // echo "<input class="form-control" type="text" id="ev_name" name="ev_name" value=".$ev->ev_name.">";
                                             echo "<input class='form-control' type='text' id='ev_name' name='ev_name' value='".$ev->ev_name."'>";
                                                                ?>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                  <?php
                                                                echo "<label>คำบรรยาย</label>";
                                                           
                                                                
                                                                
                                             echo "<textarea class='form-control' rows='3' id='ev_caption' name='ev_caption'>".$ev->ev_caption."</textarea>";
                                                                ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                 <?php
                                                                echo "<label>วันที่เริ่มงาน</label>";
                                                           
                                                                
                                                                
                                                                echo "<input class='form-control' type='date' id='ev_dateS' name='ev_dateS' value='".$ev->ev_dateS."'>";
                                                    ...
                                                    <div class="col-lg-6">
                                                                <?php
                                                                echo "<label>วันสิ้นสุดงาน</label>";
                                                               // echo "<input class="form-control" type="text" id="ev_name" name="ev_name" value=".$ev->ev_name.">";
                                                                 echo "<input class='form-control' type='date' id='ev_dateF' name='ev_dateF' value='".$ev->ev_dateF."'>";
                                                                ?>
                                                ...
                                                <div class="row ">
                                                    <div class="col-lg-6 ">
                                                        <div class="form-group ">
                                                                <?php
                                                                echo " <label>วันที่เริ่มจองบูธ</label>";
                                                               // echo "<input class="form-control" type="text" id="ev_name" name="ev_name" value=".$ev->ev_name.">";
                                                                 echo "<input class='form-control' type='date' id='ev_dateRS' name='ev_dateRS' value='".$ev->ev_dateRS."'>";
                                                                ?>
                                                    ...
                                                    <div class="col-lg-6 ">
                                                                <?php
                                                                echo "<label>วันสิ้นสุดจองบูธ</label>";
                                                               // echo "<input class="form-control" type="text" id="ev_name" name="ev_name" value=".$ev->ev_name.">";
                                                                 echo " <input class='form-control' type='date' id='ev_dateRF' name='ev_dateRF' value='".$ev->ev_dateRF."'>";
                                                                ?>
                                                ...
                                                <div class="row ">
                                                    <div class="col-lg-12 ">
                                                                <?php
                                                                echo "<label>เอกสารประกอบการจอง</label>";
                                                               echo " <div class='input-group form-group-no-border'>";
                                                                 echo " <input type='file' id='ev_file' name='ev_file' value='".$ev->document_id."'>";
                                                                ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                <?php
                                                                echo "<label>รูปภาพของงาน</label>";
                                                               echo "<div class='input-group form-group-no-border'>";
                                                                 echo "<input type='file' id='ev_image' name='ev_image' value='".$ev->image_id."'>";
                                                                ?>
                                                  ...
                                                  <div class="row">
                                                                ...
                                                                echo "<label>รูปภาพของงาน</label>";
                                                               echo "<div class='input-group form-group-no-border'>";
                                                                 echo "<input type='file' id='ev_image' name='ev_image' value='".$ev->plan_id."'>";
                                                                ?>
