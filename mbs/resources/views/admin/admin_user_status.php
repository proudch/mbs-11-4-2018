...
<head>
    ...
    <title>ADMIN |ตรวจสอบคำขออนุมัติของสมาชิก</title>
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown">
                       ...
                       <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="http://localhost/mbs/public/admin-eventstatus">งานนิทรรศการ</a>
                            </li>
                            <li >
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="http://localhost/mbs/public/admin-user-status"> ข้อมูลสมาชิก</a>
                    </div>
                        ...
                        echo "<tbody>";
                         echo "<tr>";
                          ...
                          echo "<td class='td-actions text-right'>";
                                   ...
                                   echo "<button type='button' rel='tooltip' title='Edit Task' class='btn btn-primary btn-simple btn-xs'>
                                 <i class='material-icons'><a href='http://localhost/mbs/public/admin-edit-user/".$usess->id."'>edit</i></a>
                                  </button>";
                                echo "</td>";
                                ...
                                echo "<td class='td-actions text-right'>";
                                        ...
                                        echo "<i class='material-icons'><a href='http://localhost/mbs/public/deleteuser/".$usess->id."'>delete</i></a>";
