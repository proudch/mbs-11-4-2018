                        ...
                        echo "<tbody>";
                         echo "<tr>";
                          ...
                          echo "<td class='td-actions text-right'>";
                                 ...
                                 <i class='material-icons'><a href='http://localhost/mbs/public/admin-edit-admin/".$amss->id."'>edit</i></a>
                                  </button>";
                                echo "</td>";
                                ...
                                echo "<td class='td-actions text-right'>";
                                        ...
                                        echo "<i class='material-icons'><a href='http://localhost/mbs/public/deleteadmin/".$amss->id."'>delete</i></a>";
