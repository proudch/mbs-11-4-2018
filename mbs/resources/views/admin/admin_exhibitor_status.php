...
<head>
    ...
    <title>ADMIN |ตรวจสอบคำขออนุมัติของผู้ประกอบการ</title>
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li >
                                <a href="http://localhost/mbs/public/admin-addbooth">โซน-บูธ</a>
                            </li>
                        </ul>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="http://localhost/mbs/public/admin-exhibitor-status"> ขออนุมัติ</a>
                    </div>
                        ...
                        echo "<tbody>";
                         echo "<tr>";
                          ...
                          echo "<td class='td-actions text-right'>";
                                 ...
                                 <i class='material-icons'><a href='http://localhost/mbs/public/admin-edit-exhibitor/".$exss->id."'>edit</i></a>
                                  </button>";
                                echo "</td>";
                                ...
                                echo "<td class='td-actions text-right'>";
                                        ...
                                        echo "<i class='material-icons'><a href='http://localhost/mbs/public/deleteexhibitor/".$exss->id."'>delete</i></a>";
