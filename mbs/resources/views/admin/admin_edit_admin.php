...
<!--                             <li class="dropdown">
            ...
            <div class="content">
                <div class="container-fluid">
                    <form action="http://localhost/mbs/public/admin-update-admin" method="post">
                                    ...
                                    <div class="card-content table-responsive">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                                echo "<input type='hidden' id='id' name='id' value='".$am->id."'>";
                                                                echo "<label>ชื่อ</label>";

                                             echo "<input class='form-control' type='text' id='name' name='name' value='".$am->name."'>";
                                                                ?>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                      ...
                                                      echo "<input class='form-control' id='lname' name='lname' value='". $am->lname."'>"; 
                                                         ?>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                echo "<input type='radio' name='rad_status' id='rad_status' value='". $am->status."'checked='checked' />ผู้ดูแลระบบ";
                                                    echo "</label>";
                                                    ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div id="divStudentID" class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    echo "<input class='form-control' id='studentID' name='studentID' value='". $am->studentID."'>";
                                                     ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                      <?php
                                                        ...
                                                        echo "<input class='form-control' name='username' id='username' value='". $am->username."'>";
                                                    ?>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                 ...
                                                 <?php
                                                        ...
                                                        echo "<input class='form-control' type='password' name='password' id='password' value='". $am->password."'>";
                                                    ?>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                             ...
                                             <?php
                                                        ...
                                                        echo "<input class='form-control' id='tel' name='tel' value='". $am->tel."'>";
                                            ...
                                            <div class="col-lg-6">
                                               ...
                                               <?php
                                                        ...
                                                        echo "<input class='form-control' type='email' id='email' name='email' value='". $am->email."'>";
                                                    ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="dropdown">
                                                        <select class="btn btn-default dropdown-toggle" id="dep" name="dep">
                                                            ...
                                                            <option value="#">ประสานงาน</option>
                                                            <option value="#">ฝ่ายการเงิน</option>
