                ...
                <ul class="nav">
                    ...
                    <li class="dropdown">
                       ...
                       <ul class="dropdown-menu">
                            ...
                            <li  class="active">
                                <a href="http://localhost/mbs/public/admin-event">จองบูธ</a>
                            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-footer">
                                <a href="http://localhost/mbs/public/admin-check-event1-Free" class="btn btn-danger pull-right">อ่านเพิ่มเติม</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-footer">
                                <a href="http://localhost/mbs/public/admin-check-event1-wait" class="btn btn-warning pull-right">อ่านเพิ่มเติม</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-footer">
                                <a href="http://localhost/mbs/public/admin-check-event1-payment" class="btn btn-success pull-right">อ่านเพิ่มเติม</a>
