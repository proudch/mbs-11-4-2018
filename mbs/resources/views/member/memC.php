...
<head>
    ...
    <title> MEMBER | ติดต่อผู้ดูแลระบบ</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <h4 class="title">ติดต่อผู้ดูแลระบบ</h4>
                                ...
                                <div class="card-content">
                                    <form>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">ชิ่อเรื่อง</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">เนื้อหาที่จะติดต่อ</label>
                                        ...
                                        <button type="submit" class="btn btn-primary pull-right">ส่ง</button>
                                        <button type="submit" class="btn btn-info pull-right">ยกเลิก</button>
